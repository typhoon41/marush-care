...
const supportedFaceTreatments = [
    ...
    new TreatmentDefinition({
        ...
        name: 'Premium higijenski tretman',
        price: 5000,
        duration: 90,
    ...
    new TreatmentDefinition({
        title: $localize`:@@treatments.face.massage:Masaža lica, dekoltea i ramena`,
        name: 'Masaža lica, dekoltea i ramena',
        duration: 30,
        price: 2500
    }),
    new TreatmentDefinition({
