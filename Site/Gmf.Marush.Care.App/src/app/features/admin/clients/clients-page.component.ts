...
export class ClientsPageComponent implements OnInit {
    ...
    customersList = this.clientService.getCustomers(this.pagination);
    ...
    readonly tableContent = computed(() =>
        (this.customersList.hasValue() ? this.customersList.value().items : []) as unknown as Record<string, string>[]);
