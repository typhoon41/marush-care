...
export const currentDiscounts = [
    $localize`:@@discounts.1:<h3><strong>17.8. - 21.8.</strong></h3><p>Ferul. piling + Infuzija vitam. C<br/><br/><s>8.000</s> 6.500</p>`,
    $localize`:@@discounts.2:<h3><strong>17.8. - 21.8.</strong></h3><p>Ferul. piling + Skeyndor vitam. C<br/><br/><s>9.000</s> 7.500</p>`
];
...
export class HomePageMetadata extends PageMetadata {
    ...
    override getSpecificStructuredData = (baseStructuredData: IStructuredData, _language: ILanguage) => {
        const specialAnnouncements = {
            ...
            subjectOf: [
                this.offer(currentDiscounts[0], '2026-08-21', '8000', '6500'),
                this.offer(currentDiscounts[1], '2026-08-21', '9000', '7500')
            ]
        };
