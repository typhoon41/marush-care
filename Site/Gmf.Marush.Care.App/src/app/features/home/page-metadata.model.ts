...
export class HomePageMetadata extends PageMetadata {
    override getSpecificStructuredData: (baseStructuredData: IStructuredData, language: ILanguage) => IStructuredData =
     (baseStructuredData, _language) => baseStructuredData;
